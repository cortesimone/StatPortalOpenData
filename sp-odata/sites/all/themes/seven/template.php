<?php
include_once 'includes/etl_dim_config.inc';
...
function seven_preprocess_page(&$vars) {
  ...
  if(isset($vars['theme_hook_suggestions']) && is_array($vars['theme_hook_suggestions']) && 
  	( in_array('page__node__add__metadata', $vars['theme_hook_suggestions']) || 
  	( in_array('page__node__edit', $vars['theme_hook_suggestions']) || in_array('page__node_metadata', $vars['theme_hook_suggestions']))) ) {
  	$vars['etlDimensions'] = EtlDimensionConfiguration::loadConfig(); 	
  }
}
