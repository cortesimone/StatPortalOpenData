...
<script id="labelInfoTemplate" type="text/x-jquery-tmpl">
	{{if (alias == 'DO_X')}}
		<input class="etl_alias" style="width: 400px;background-color: whiteSmoke; color: gray;" type="text" maxlength="100" size="100" id="tb_alias_${id}" value="Longitudine" readonly="readonly" data-type='longitude' />
		<br />
	{{else (alias == 'DO_Y')}}
		<input class="etl_alias" style="width: 400px;background-color: whiteSmoke; color: gray;" type="text" maxlength="100" size="100" id="tb_alias_${id}" value="Latitudine" readonly="readonly" data-type='latitude'  />
		<br />
	{{else}}
   		<input class="etl_alias" style="width: 400px;" type="text" maxlength="100" size="100" id="tb_alias_${id}" value="${alias}" data-type='general' />
		<br />
	{{/if}}
</script>	
...
.navbar {
  ...
  <input id="etl-page-type" type="hidden" name="etl-page-type" value="edit-metadata" />
  <div id="page">
    ...
    <div id="content" class="clearfix">
      ...
      <?php if ($action_links): ?><ul class="action-links"><?php print render($action_links); ?></ul><?php endif; ?>
    	...
    	<ul>
			...
			<li class="tab-etl"><a class="disabled tabs-etl-class" href="#tabs-etl"><?php echo t('Dato'); ?></a></li>
			...
			<!-- tab attivo solo in modifica scheda -->
			<li><a class="disabled tabs-edit-label-class" href="#tabs-edit-label"><?php echo t('Modifica etichette'); ?></a></li>
		</ul>
    	...
    	?>
    		<div class="navbar" >
    			<button class="bt-next" id="step0-next" data-next="1" title="<?php echo t('Conferma i dati inseriti e avanza allo step successivo'); ?>"><?php echo t('Avanti'); ?></button>
    		</div>
    	</div>
...
// 				print render($attach_form);
		...
		<!-- tab attivo solo in modifica scheda -->
		<div id="tabs-edit-label">
			<div id="loadDataFormLoadingForLabel"></div>
				<div class="editLabelText">
					Modificare le etichette e cliccare su 'Applica' per rendere effettive le modifiche
				</div>
			<div id="labels-to-edit"></div>
			<div id="label-editing-button" class="next" style="float:left;" onclick="StatPortalOpenData.ETL.setAliases();">Applica</div>
			<div style="clear:both;"></div>
			<div id="apply-result" class="messages status" style="display:none;">Modifiche applicate correttamente.</div>
		</div>
...
<!-- 	</div> -->
	...
	<div class="form-actions" id="edit-actions-copy">
		<input type="submit" id="edit-submit-copy" name="op" value="<?php echo t('Salva'); ?>" class="form-submit" /><!-- disabled="disabled"  -->
		<input type="submit" id="edit-preview-copy" name="op" value="<?php echo t('Anteprima'); ?>" class="form-submit" disabled="disabled">
		<input type="submit" id="edit-delete-copy" name="op" value="<?php echo t('Elimina'); ?>" class="form-submit">
	</div>
