...
(function($) {
	...
	$.fn.jshowoff = function(settings) {
		...
		this.each(function(i) {
			...
			if(config.links){
				addSlideLinks();
				$('.'+uniqueClass+'-slidelinks div').eq(0).addClass(uniqueClass+'-active jshowoff-active');
			};
			...
			function transitionTo(gallery,index) {
				...
				if(config.links){
					...
					$('.'+uniqueClass+'-slidelinks div').eq(counter).addClass(uniqueClass+'-active jshowoff-active');
				};
			};
			...
			function addSlideLinks() {
				...
				$.each(gallery, function(i, val) {
					...
					$('<div class="jshowoff-slidelink-'+i+' '+uniqueClass+'-slidelink-'+i+'" href="#null">'+linktext+'</div>').bind('click', {index:i}, function(e){ goToAndPause(e.data.index); return false; }).appendTo('.'+uniqueClass+'-slidelinks');
				});
			};		
