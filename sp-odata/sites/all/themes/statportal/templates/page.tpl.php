...
drupal_add_js($theme_path  . '/js/page.js', array('weight' => -20, 'group' => 100));
        ...
        <?php if ($site_name): ?>
          <?php if ($title): ?>
            <div id="site-name"<?php if ($hide_site_name) { print ' class="element-invisible"'; } ?>>
              <strong>
                <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"><span><?php print $site_name; ?></span><span style="font-size: 12px; font-weight: normal; font-style: italic;"> (Beta)</span></a>
              </strong>
            </div>
            <?php if ($site_slogan): ?>
