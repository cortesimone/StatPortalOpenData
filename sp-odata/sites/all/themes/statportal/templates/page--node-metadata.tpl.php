      ...
      <div id="metadata-header" class="initial_metadata_loading" >
	      ...
	      <?php if ($title): ?>
	        ...
	        <div id="sub-title">
	        	...
	        	<span id="author-subtitle-label"><?php print t('Fonte:'); ?></span><span id="author-subtitle">-</span>
			<br/>
	        	<span id="lastupdate-subtitle-label"><?php print t('Aggiornato al:'); ?></span><span id="lastupdate-subtitle">-</span>
