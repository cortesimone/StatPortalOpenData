	...
	$.widget("ech.multiselect", {
      ...
      var alternateRows = 0;
          ...
          html.push('<div style="background:#F7F7F7;">');
				...
				////float: left;
				html.push('<label title="' + description + '" class="' + labelClasses.join(' ') + '" style="float:left;"' + '>');
				html.push('<input id="' + inputID + '"style="vertical-align:middle;" data-alias="' + $(this).attr('data-alias') + '" data-id="' + $(this).attr('data-id') + '" name="' + $(this).attr('name') + '" type="' + (o.multiple ? "checkbox" : "radio") + ($(this).hasClass('dimension') ? '" onclick="' + 'StatPortalOpenData.ODataUtility.activeAggregationFunctionIfNecessary();' : '') + '" class="' + $(this).attr('class') + '" value="' + value + '" title="' + title + '"');
				...
				html.push(' /><span style="padding-left: 5px;vertical-align: middle;">' + title + '</span>');
				html.push('</label>');
